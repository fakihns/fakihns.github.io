            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><div class="sb-nav-link-icon"><i class="bi bi-card-list"></i></div>Stock Barang</h1>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <br>
                                                        <input type="text" name="panjang" value="<?=$panjang;?>" class="form-control" required>
                                                        <br>
        ...
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    $barang_id = generateBarangID($conn);
                    ?>
                    <input type="text" name="idbarang" value="<?php echo $barang_id; ?>" readonly class="form-control">
                    <br>
                    <input type="text" name="namabarang" placeholder="Nama Barang" class="form-control" required>
                    <br>
                    <input type="text" name="panjang" placeholder="Panjang Barang" class="form-control" required>
                    <br>
                    <input type="text" name="stok" placeholder="Stok Barang" class="form-control" required>
                    <br>
