            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><div class="sb-nav-link-icon"><i class="bi bi-cash-coin"></i></div>Transaksi</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <a href="exporttransaksi.php" class="btn btn-info">Cetak Data</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <?php
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <button type="submit" class="btn btn-warning" name="updatetransaksi">Edit</button>
                                                    </div>
                                                </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal fade" id="delete<?=$idt;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                    Apakah Anda Yakin Ingin Menghapus <?=$totalharga;?>?
                                                    <input type="hidden" name="idt" value="<?=$idt;?>">
                                                    <input type="hidden" name="idc" value="<?=$idc;?>">
                                                    <br>
                                                    <div class="modal-footer justify-content-between">
                                                        <button type="submit" class="btn btn-danger" name="deletetransaksi">Delete</button>
                                                    </div>
                                                </form>
                                                </div>
                                            </div>
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <?php 
            // Panggil fungsi untuk menghasilkan ID barang otomatis
            $transaksi_id = generateTransaksiID($conn);
            ?>
            <input type="text" name="idtransaksi" value="<?php echo $transaksi_id; ?>" readonly class="form-control">
            <br>
            <input type="text" name="namacustomer" placeholder="Nama Customer" class="form-control" required>
            <br>
            <button type="submit" class="btn btn-primary" name="transaksi">Submit</button>
        </div>
    </form>
</html>