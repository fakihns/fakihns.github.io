            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><div class="sb-nav-link-icon"><i class="bi bi-house-add-fill"></i></div>Pengembalian</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <a href="exportpengembalian.php" class="btn btn-info">Cetak Data</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <?php
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <button type="submit" class="btn btn-warning" name="updatepengembalian">Edit</button>
                                                    </div>
                                                </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal fade" id="delete<?=$idp;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                <h4 class="modal-title">Delete Pengembalian</h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Tambahkan Pengembalian</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <input type="text" name="idtransaksi" value="<?php echo $pengembalian_id; ?>" readonly class="form-control">
        <br>
        ...
        <br>
        <button type="submit" class="btn btn-primary" name="pengembalian">Submit</button>
    </div>
</form>
        </div>
    </div>
